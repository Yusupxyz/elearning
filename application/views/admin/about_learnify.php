                ...
                <section class="section">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang E Learning Smansa</h2>
                                <hr>
                                <p class="card-text"> <br> <br> ELearning ini dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
                            </div>
                        </div>
                    </div>
                </section>
