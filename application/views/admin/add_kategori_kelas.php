                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Kategori Kelas</h2>
                                <hr>
                                <p class="card-text">Kategori kelas bisa ditambahkan hanya oleh admin.
                                </p>
                        ...
                        <div class="card card-success">
                            <div class="col-md-12 text-center">
                                <p class="registration-title font-weight-bold display-4 mt-4" style="color:black; font-size: 50px;">
                                    Tambah Kategori Kelas</p>
                                <p style="line-height:-30px;margin-top:-20px;">Silahkan isi data data yang diperlukan
                                    dibawah </p>
                                <hr>
                            </div>
                            <div id="detail" class="card-body">
                                <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/add_kategori_kelas') ?>">
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="mapel[]" value="<?= $row->id ?>"><?= $row->nama ?>
                                                    </label>
                                                        </div>   
                                                        <?php endforeach;?>
