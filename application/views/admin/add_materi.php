                                    ...
                                    <div class="col-md-12 bg-white" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" name="nama_mapel" id="nama_mapel" required placeholder="Pilih nama guru yang valid agar nama mapel muncul" readonly>
                                                <input type="text" class="form-control" name="mapel" id="mapel" required placeholder="Pilih nama guru yang valid agar nama mapel muncul" readonly>
