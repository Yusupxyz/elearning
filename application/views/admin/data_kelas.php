...
Kelas dapat terus belajar dan mengajar dimana saja dan kapan saja.
-->
...
<head>
    ...
    <title>Data Kelas - Learnify</title>
    <!-- General CSS Files -->
                        ...
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                                <div class="table-responsive">
                                    ...
                                    <p class="small font-weight-bold">Pendaftaran kelas hanya dapat dilakukan admin dan tidak bisa dilakukan sendiri</p>
                                </div>
                            </div>
                        </div>
                    </div>
