                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_materi/' . $u->materi_id); ?>" class="btn btn-info">Update ⭢</a>

                                                        <a href="<?php echo site_url('admin/delete_materi/' . $u->materi_id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                    </td>
