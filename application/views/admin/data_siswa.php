                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <?php echo $u->is_active=='1'?'Aktif':'Tidak Aktif' ?>
                                                    </td>

                                                    <!-- <td class="text-center">
                                                        <a href="<?php echo site_url('admin/detail_siswa/' . $u->siswa_id); ?>" class="btn btn-success">Detail ⭢</a>
                                                    </td> -->

                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_siswa/' . $u->siswa_id); ?>" class="btn btn-info">Update ⭢</a>

                                                        <a href="<?php echo site_url('admin/delete_siswa/' . $u->siswa_id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                    </td>
