...
<head>
    ...
    <title>Data Tugas - Learnify</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Tugas Learnify</h2>
                            <hr>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_tugas/' . $u->id); ?>" class="btn btn-info">Update ⭢</a>
    ...
    <?php if ($this->session->flashdata('success-reg')) : ?>
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Data Tugas Telah Ditambah!',
