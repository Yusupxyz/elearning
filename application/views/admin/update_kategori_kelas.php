...
<body>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Kategori Kelas</h2>
                                <hr>
                    ...
                    <div class="card card-success">
                        ...
                        <?php foreach ($user as $u) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('admin/kelas_kategori_edit') ?>">

                                    <div class="form-group" id="detail">
                                    <label for="inputEmail4">Nama Kategori</label>
                                        <input id="nama" type="text" value="<?= $u->kategori ?>" class="form-control" name="nama">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Daftar Mata Pelajaran</label>
                                            <?php foreach($mapel as $row):?>

                                            <div class="checkbox">
                                            <label>
                                                <input type="checkbox" <?php echo in_array($row->id, $kapel)?'checked':'';?> name="mapel[]" value="<?= $row->id ?>"><?= $row->nama ?>
                                            </label>
                                                </div>   
                                                <?php endforeach;?>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" value="<?= $u->id ?>" name="id" class="btn btn-success btn-lg btn-block">
                                            Update data ⭢
                                        </button>
                                    </div>
                                </form>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2021 <div class="bullet"></div> <a href="http://www.sman1sampit.sch.id">SMAN 1 Sampit</a>
        </div>
    </footer>
    <!-- End Footer -->
