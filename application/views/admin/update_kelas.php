...
<head>
    ...
    <title>Update Data Kelas - Learnify</title>
    <!-- General CSS Files -->
                                ...
                                <div id="" class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <select required id="inputState" name="kategori" class="form-control">
                                                ...
                                                <option <?php echo $row->id=='1'?'selected':'';?> value="<?php echo $row->id;?>" ><?php echo $row->kategori;?></option>
                                                <?php endforeach;?>
                                            </select>
                                    ...
                                    <div class="form-group" id="detail">
                                        ...
                                        <input id="nama" type="text" value="<?= $u->nama ?>" class="form-control" name="nama">
                                    ...
                                    <div id="" class="row">
                                        <div class="form-group col-12">
                                            <label>Status</label>
                                            <select class="form-control selectric" name="aktif">
                                                <option value="1" <?= $u->aktif=='1'?'selected':''; ?>>Aktif</option>
                                                <option value="0" <?= $u->aktif=='0'?'selected':''; ?>>Tidak Aktif</option>
                                            </select>
