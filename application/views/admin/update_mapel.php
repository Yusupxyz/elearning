...
<head>
    ...
    <title>Update Data Mapel - Learnify</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    ...
                    <div class="card card-success">
                        ...
                        <?php foreach ($user as $u) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('admin/mapel_edit') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="info" type="text" value="<?= $u->info ?>" class="form-control" name="info">
