                        ...
                        <?php foreach ($user as $u) { ?>
                            ...
                            <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1" class="font-weight-bold" style="font-size: 20px;">NIS</label>
                                    <input type=" text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required name="nis" value="<?= $u->nis ?>">
                                    <label for="exampleInputEmail1" class="font-weight-bold" style="font-size: 20px;">Nama</label>
                                    <input type=" text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required name="nama" value="<?= $u->siswa ?>">
                                    <label for="exampleInputEmail1" class="font-weight-bold" style="font-size: 20px;">Kelas</label>
                                    <select class="form-control" name="kelas" required>
                                        <option  value="">--Pilih--</option>
                                        <?php foreach($kelas as $row):?>
                                        <option value="<?php echo $row->id;?>" <?= $u->kelas_id==$row->id?'selected':''; ?>><?php echo $row->nama;?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
