...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Tambah Pertanyaan</title>
                        ...
                        <div class="row">
                            <div class="col-md-12 bg-white p-4 container"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    action="<?=base_url('guru/tambah_soal/'.$id)?>">
                                    <input type="hidden" name="id" value="<?= $id ?>">
                                    <input type="hidden" name="urutan" value="<?= $count+1 ?>">
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Pertanyaan ke <?= $count+1 ?></label>
