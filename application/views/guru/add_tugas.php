                                ...
                                <form method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input required type="hidden" readonly name="nip" value="<?php
$data['user'] = $this->db->get_where('guru', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nip'];?>" class="form-control" id="inputEmail4">
...
echo $data['user']['nama_guru'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input required type="text" name="judul" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="number" name="durasi" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">
