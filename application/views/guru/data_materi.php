                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('guru/update_materi/' . $u->materi_id); ?>" class="btn btn-info">Update ⭢</a>

                                                        <a href="<?php echo site_url('guru/delete_materi/' . $u->materi_id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                    </td>
