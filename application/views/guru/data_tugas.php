                                    ...
                                    <table id="example" class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            <tr class="text-center">
                                                <th scope="col">No.</th>
                                                <th scope="col">Informasi Tugas</th>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        ...
                                                        <br><small><b>Tanggal berakhir : </b> <?php echo $u->tgl_akhir ?></small>
                                                        </td>
                                                    ...
                                                    <td>
                                                        <?= $u->tampil_siswa=='0'?'Tidak Aktif':'Aktif'; ?>
                                                    </td>
                                                    

                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('guru/soal_tugas/' . $u->tugas_id); ?>" class="btn btn-primary"><i class="fa fa-list"></i>Soal </a>
                                                        <?php if($u->tampil_siswa=='0'){ ?>
                                                            <a href="<?php echo site_url('guru/terbit_tugas/' . $u->tugas_id); ?>" class="btn btn-success">Terbitkan ✔</a>
                                                        <?php }else{ ?>
                                                            <a href="<?php echo site_url('guru/tutup/' . $u->tugas_id); ?>" class="btn btn-danger">Tutup ✘</a>
                                                        <?php } ?>
                                                            <a href="<?php echo site_url('guru/update_tugas/' . $u->tugas_id); ?>" class="btn btn-default">Update ⭢</a>
                                                        <?php if($u->tampil_siswa=='1'){ ?>
                                                            <a href="<?php echo site_url('guru/koreksi_tugas/' . $u->tugas_id); ?>" class="btn btn-info">Koreksi ☑</a>
                                                        <?php } ?>
                                                        </td>
