                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <strong class="text-warning"><?php echo $u->kelas ?></strong>
                                                      </td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('guru/evaluasi_kelas/' . $u->tugas_id); ?>" class="btn btn-primary"><i class="fa fa-check"></i>Evaluasi </a>
