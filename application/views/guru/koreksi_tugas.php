...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Koreksi Tugas</title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-left">
                                                        <strong class="text-info">NIS : <?= $u->nis ?></strong><br>
                                                        <strong class="text-warning">Nama : <?= $u->nama_siswa ?></strong>
                                                    </td>
                                                    <td >
                                                        <?php echo $u->kelas ?>
                                                    </td>
                                                    ...
                                                    <td >
                                                        <a href="<?php echo site_url('guru/nilai/'.$u->tugas_id.'/' . $u->jawaban); ?>" class="btn btn-primary"><i class="fa fa-list"></i>Jawaban & Nilai </a>
                                                    </td>
