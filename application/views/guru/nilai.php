...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Jawaban dan Nilai</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 bg-white p-4 container"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    action="<?=base_url('guru/update_nilai/'.$tugas_id.'/'.$jawaban->jawaban_id)?>">
                                    <input type="hidden" name="id" value="<?= $id ?>">
                                    <div class="form-group">
                                        <label for="inputState">List Jawaban</label>
                                        <div class="table-responsive">
                                            <table id="example" class="table align-items-center table-flush">
                                            <thead class="thead-light">
                                            <tr class="text-center">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="nilai" value="<?= $jawaban->nilai ?>" placeholder="isi dengan nilai">
                                    </div>
