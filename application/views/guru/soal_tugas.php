...
Learnify adalah Web edukasi yang dilengkapi video, Tugas dan sistem ujian
...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Tambah Soal</title>
                                    ...
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="<?=base_url('guru/data_materi')?>" class="kt-menu__link "><i
                                                        ...
                                                        class="kt-menu__link-text">Daftar Materi</span></a></li>
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                    ...
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="<?=base_url('guru/data_tugas')?>" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">Daftar Tugas</span></a></li>
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                ...
                                <div class="kt-notification">
                                    <div class="kt-notification__custom">
                                        <a href="<?=base_url('welcome/logout')?>"
                                            class="btn btn-label-brand btn-sm btn-bold">Keluar</a>
                                    </div>
                                </div>
                                    ...
                                    <table id="example" class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            <tr class="text-center">
                                                <th scope="col">No.</th>
                                                <th scope="col">Pertanyaan dan Pilihan</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-left">
                                                        Pertanyaan : <strong class="text-warning"><?= $u->pertanyaan ?></strong>
                                                        <table class="table table-condensed table-striped">
                                                            <tbody>
                                                                Pilihan :
                                                            <?php
                                                                foreach ($pilihan[$j++] as $value) {
                                                                ?>
                                                                <tr class="success" <?= $value->kunci=='1'?'style="background-color: #dff0d8;"':'' ?>>
                                                                    <td width="3%"><b><?= '('.$value->pilihan_urutan.')' ?></b></td>
                                                                    <td>
                                                                        <div class="btn-group pull-right" style="margin-left:10px;">
                                                                        <?php if($value->kunci=='0'){ ?>
                                                                            <a href="<?php echo site_url('guru/kunci/'.$u->tugas_id.'/'.$u->pertanyaan_id.'/'. $value->pilihan_id); ?>" class="btn btn-success">Jadikan kunci ✔</a>
                                                                        <?php } ?>
                                                                            <a href="<?php echo site_url('guru/update_pilihan/'.$u->tugas_id.'/' . $value->pilihan_id); ?>" class="btn btn-default">Update ⭢</a>
                                                                            <a href="<?php echo site_url('guru/delete_pilihan/'.$u->tugas_id.'/' . $value->pilihan_id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                                        </div>
                                                                        <p><?= $value->konten ?></p>
                                                                        <?php if($value->kunci=='1'){ ?>
                                                                            <b class="text-warning"><i class="fa fa-star"></i> Kunci Jawaban</b>
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('guru/tambah_pilihan/'.$u->tugas_id.'/' . $u->pertanyaan_id); ?>" class="btn btn-primary"><i class="fa fa-list"></i>Pilihan </a>
                                                        <a href="<?php echo site_url('guru/update_soal/' . $u->pertanyaan_id); ?>" class="btn btn-default">Update ⭢</a>
                                                        <a href="<?php echo site_url('guru/delete_soal/'.$u->tugas_id.'/' . $u->pertanyaan_id); ?>" class="btn btn-danger remove">Delete ✖</a>
                                                    </td>
