...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Update Materi</title>
                        ...
                        <?php foreach ($user as $u) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('guru/materi_edit') ?>">
                                    <input type="hidden" name="id" value="<?= $u->materi_id ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly id="nama_mapel" type="text" value="<?= $u->nama ?>" class="form-control" name="nama_mapel">
