...
Learnify adalah Web edukasi yang dilengkapi video, Pilihan dan sistem ujian
...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Update Pilihan</title>
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                        ...
                        <?php foreach ($user as $u) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('guru/pilihan_edit/'.$u->id) ?>">
                                    <input type="hidden" name="id" value="<?= $u->id ?>">
                                    <input type="hidden" name="tugas_id" value="<?= $tugas_id ?>">
                                  
                                    <div class="form-group">
                                        <label for="inputState">Pilihan</label>
                                        <select required id="inputState" name="urutan" class="form-control">
                                            <option value="">-- Pilih --</option>
                                            <option value="A" <?= $u->urutan=='A'?'selected':''; ?>>A</option>
                                            <option value="B" <?= $u->urutan=='B'?'selected':''; ?>>B</option>
                                            <option value="C" <?= $u->urutan=='C'?'selected':''; ?>>C</option>
                                            <option value="D" <?= $u->urutan=='D'?'selected':''; ?>>D</option>
                                            <option value="E" <?= $u->urutan=='E'?'selected':''; ?>>E</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <textarea id="ckeditor" class="form-control" required name="pilihan"
                                            rows="3"><?= $u->konten ?></textarea>
                                    </div>
                                    <div class="form-group">
...
var ckeditor = CKEDITOR.replace('pilihan',{
			height:'200px'
        });
