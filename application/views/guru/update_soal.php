                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                        ...
                        <?php foreach ($user as $u) { ?>
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('guru/soal_edit/'.$u->id) ?>">
                                    <input type="hidden" name="id" value="<?= $u->id ?>">
                                    <input type="hidden" name="tugas_id" value="<?= $u->tugas_id ?>">
                                  
                                    <div class="form-group">
                                        <label for="ckeditor">Pertanyaan ke <?= $u->urutan ?></label>
                                        <textarea id="ckeditor" class="form-control" required name="soal"
                                            rows="3"><?= $u->pertanyaan ?></textarea> 
                                    </div>
                                    <div class="form-group">
