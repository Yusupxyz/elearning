...
Learnify adalah Web edukasi yang dilengkapi video, Soal dan sistem ujian
...
<head>
    <meta charset="utf-8" />
    <title>Learnify - Update Soal</title>
...
?>
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                        ...
                        <div class="row">
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('guru/tugas_edit/'.$user->tugas_id) ?>">
                                    <input type="hidden" name="id" value="<?= $user->id ?>">
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Nama Mata Pelajaran</label>
                                            <input required type="hidden" readonly name="nama_mapel" value="<?php echo $user->id;?>" class="form-control" id="inputEmail4">
                                            <input required type="text" readonly value="<?php echo $user->nama;?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Judul Tugas</label>
                                            <input required type="text" name="judul" value="<?php echo $user->judul;?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                   
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Informasi Tugas</label>
                                        <textarea class="form-control" required name="info"
                                            id="exampleFormControlTextarea1" rows="3"><?php echo $user->tugas_info;?></textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <option value="">-- Pilih Kelas --</option>
                                            ...
                                            <option value="<?php echo $row->id;?>" <?= $user->kelas_id==$row->id?'selected':'' ?>><?php echo $row->nama;?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Durasi Pengerjaan (menit)</label>
                                            <input required type="number"value="<?php echo $user->durasi;?>" name="durasi" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">

                                    <div class="form-group col-md-6">
                                    <label for="inputState">Tanggal Berakhir</label>
                                    <div class='input-group date' id='datetimepicker1'>
                                        <input type='text' name="tgl_akhir" value="<?php echo $user->tgl_akhir;?>" class="form-control" />
