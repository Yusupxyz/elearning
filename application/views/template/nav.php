        ...
        <div class="top_menu row m0">
            <div class="container">
                <div class="float-right">
                    <!-- <a class="dn_btn" href="mailto:fadilla1997.df@gmail.com">fadilla1997.df@gmail.com</a> -->
                </div>
            </div>
        </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/logo_smansa.png" alt=""></a>
