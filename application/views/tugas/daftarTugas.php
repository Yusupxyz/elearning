...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/') ?>css/tugas_style.css">
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    <h1 class="display-4" data-aos="fade-down" data-aos-duration="1400">Silahkan pilih tugas yang akan
                        kamu kerjakan !
                    </h1>
                    ...
                    <hr width="80%">
                    <p data-aos="fade-down" class="font-weight-bold" data-aos-duration="1800">Silahkan pilih tugas yang
                        akan kamu akses
                        dibawah
                        ini!
                    </p>
                ...
                <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                    <div class="card tugas w-150 border-0">
                        <div class="card-body p-5">
                            ...
                            <p class=" card-text">
                                <?= substr($u->judul, 0, 100); ?>&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.&nbsp;.
                            </p>
                            <a href="<?php echo site_url('tugas/kerjakan/'. $u->tugas); ?>" class="btn btn-success">Kerjakan
                                Sekarang !</a>
                        </div>
                    </div>
                </div>
